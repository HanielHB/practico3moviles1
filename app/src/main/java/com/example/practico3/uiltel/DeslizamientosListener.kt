package com.example.practico3.uiltel
...
open class DeslizamientosListener(context : Context?) : View.OnTouchListener
{
    var gestureDelector: GestureDetector

    override fun onTouch(v: View?, motionEvent: MotionEvent?): Boolean {
        return gestureDelector.onTouchEvent(motionEvent ?: return false)
    }
